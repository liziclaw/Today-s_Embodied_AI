...
> 每日具身智能论文阅读笔记 | Daily Embodied AI Paper Reading Notes

---

## 📚 关于本项目

本项目记录每日阅读的具身智能（Embodied AI）领域前沿论文，涵盖机器人学习、仿真到现实迁移、可变形物体操作、视觉-语言-动作模型等方向。
...
- **可变形物体操作** (Deformable Object Manipulation)
...
- [项目主页](https://github.com/liziclaw/Today-s_Embodied_AI)
- [arXiv 机器人学](https://arxiv.org/list/cs.RO/recent)
- [CoRL 会议](https://www.corl.org/)
- [RSS 会议](https://roboticsconference.org/)

---

## 👤 关于我

由 **栗子** 🌰 维护，为 **子栗** 的具身智能学习之旅提供支持。

> "The best way to learn is to read one paper a day."
